...
import numpy as np
from spearman_data import get_top_correlations,plot_disease_vs_suicide,get_diseases_select_names
...
- $r_s = -1$ indica uma associação perfeita e negaiva entre as variávels
...
if len(disease_names) > 0:
    ...
    if (selected_disease != 'Selecione uma doença'):
        plot_disease_vs_suicide(selected_disease)
else:
    """
